...
const { createClubProfile } = require('../models/clubModel');
...
async function register({ email, password, role }) {
  ...
  // If the user is a scout or club, automatically create a minimal profile
  let message = null;
  if (role === 'scout') {
    ...
    await createClubProfile(user.id);
    message = 'Compte club créé ! Pensez à compléter votre profil.';
  }
